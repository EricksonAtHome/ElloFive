...
class DirectoryProcessor(object):
    ...
    def parse_arguments(self, description, subparser, command):
        self.parser.add_argument(
            ...
            dest="input_dir",
            default="input",
            help="Input directory. A directory containing the files you wish to process. Defaults to 'input'",
        )
        self.parser.add_argument(
            "-o",
            "--output-dir",
            ...
            dest="output_dir",
            default="output",
            help="Output directory. This is where the converted files will be stored. Defaults to 'output'",
        )
        self.parser.add_argument(
            "-v",
            "--verbose",
